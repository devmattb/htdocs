  ...
  <div class="col s12 row">
    ...
    <div id="myExpertise" class="white col s12 row center">
        ...
        <div class="langLibsAndFrameworks col s12">
            ...
            <div class="col s12 hide-on-small-only hide-on-med-and-down">
                <!--<a href="https://en.wikipedia.org/wiki/Cascading_Style_Sheets" target="_blank">--><img src="img/lang_and_lib_logos/html_and_css.png"><!--</a>-->
                <!--<a href="https://en.wikipedia.org/wiki/JavaScript" target="_blank">--><img style="width: 50px;" src="img/lang_and_lib_logos/javascript.png"><!--</a>-->
                <!--<a href="http://getbootstrap.com/" target="_blank">--><img style="width: 75px;" src="img/lang_and_lib_logos/bootstrap.jpg"><!--</a>-->
                <!--<a href="http://materializecss.com/about.html" target="_blank">--><img style="width: 75px; " src="img/lang_and_lib_logos/materialize.png"><!--</a>-->
                <!--<a href="https://en.wikipedia.org/wiki/MongoDB" target="_blank">--><img style="width: 140px;"  src="img/lang_and_lib_logos/mongodb.png"><!--</a>-->
                <!--<a href="https://en.wikipedia.org/wiki/Node.js" target="_blank">--><img src="img/lang_and_lib_logos/nodejs.png"><!--</a>-->
                <!--<a href="https://en.wikipedia.org/wiki/Meteor_(web_framework)" target="_blank">--><img style="width: 120px;" src="img/lang_and_lib_logos/meteorjs.png"><!--</a>-->
                <!--<a href="https://en.wikipedia.org/wiki/Java_(programming_language)" target="_blank">--><img style="width: 40px;" src="img/lang_and_lib_logos/java.png"><!--</a>-->
            </div>
                    ...
                    <div id="mask"> <!-- Används för att dölja bilder utanför slidern -->
                        ...
                        <ul> <!-- Lista med alla de bilder som ska visas i bild slidern -->
                            ...
                            <li id="second" class="secondanimation"> <!-- Placerar andra bilden som ska visas och animeras -->
                                ...
                                <!--</a>-->
                                <!--<a href="https://en.wikipedia.org/wiki/Meteor_(web_framework)" target="_blank">-->
                            ...
                            <li id="third" class="thirdanimation"> <!-- Placerar tredje bilden som ska visas och animeras -->
                                ...
                                <!--</a>--> 
                                <!--<a href="http://materializecss.com/about.html" target="_blank">-->
   ...
   <!-- MEDIUM -->
    <div class="col s12 center breakBlock breakBlockMedium black hide-on-large-only hide-on-small-only">
        ...
        <div class="col s12 partnerLogoDiv left" style="top: 2vmin;">
            ...
            <div class="col s12 left-align">
                <a href="https://www.enigio.com/" target="_blank"><img style="width:200px;" src="img/enigio2.png"></a>
                <a href="https://tangar.io/" target="_blank"><img style="width:150px; position: relative; left: 50px; top: -27px;" src="img/tangar_logo.png"></a>
   ...
   <div class="col s12 center breakBlock breakBlockSmall black hide-on-med-and-up">
        ...
        <div class="col s12 partnerLogoDiv left" style="top: 2vmin;">
            ...
            <div class="col s12 left-align">
                <!--<a href="https://www.enigio.com/" target="_blank">--><img style="width:130px;" src="img/enigio2.png"><!--</a>-->
                <!--<a href="https://prfktbrand.com/" target="_blank">--><img style="width:100px; position: relative; left: 30px; top: -18px;" src="img/tangar_logo.png"><!--</a>-->
            </div>
